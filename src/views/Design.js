    ...
    return(
        ...
        <main className={"text-white lander flex lg:pt-24 mmd:flex mmd:justify-center mmd:flex-col mmd:pt-12 mmd:relative"}>
            ...
            <div className="flex-initial relative test mmd:text-center">
                ...
                <div className={"cardContainer flex lg:mt-80  lg:-ml-80 lg:mr-40 mmd:flex-row mmd:justify-center mmd:w-full mmd:text-2xl mmd:text-left mmd:mb-48 mmd:relative mmd:mx-4"}>
